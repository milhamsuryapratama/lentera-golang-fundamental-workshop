...
// 💻 return properti nama dari struct Siswa

// 💻 buatlah method dengan nama GetAlamat
// 💻 return properti alamat dari struct Siswa

func main() {
	var s Siswa

	// 💻 panggil method setNama dan setAlamat

	// 💻 buat variable nama dan panggil method GetNama
